...
**Exec-summary findings only.** Each exec-summary bullet states a conclusion, a
...
**No process attribution.** Flag "per {{STAKEHOLDER}}", "{{STAKEHOLDER}}
...
**No restating known info.** For internal readers, flag Frame / Scope / Intro /
...
**No scaffolding.** Flag meta-structure: Decision target / Decision owner / Scope
...
**No unrelated context / scope bleed.** Each doc is scoped to one decision. Flag
...
**No invented requirements.** Flag any "what X needs" item that doesn't trace to
...
**No deliverable sizing (scope docs).** Flag "one-pager", "1-page memo", "bridge
...
**No slope.** Flag advocacy framing. Lead with limitations and trade-offs, not
...
**Project glossary.** Enforce the project's canonical terms over their common
...
**Named owners.** Owner / responsible / decision-maker columns in internal
deliverables name the person ({{STAKEHOLDERS}}), not generic labels. External
briefs keep generic labels.

## External-brief rules (external audience only)
